 ...
 * this page makes to WebGoat itself repeats the token from the cookie. This wraps XMLHttpRequest
 * rather than jQuery because not every lesson script goes through jQuery.
 */
(function () {
